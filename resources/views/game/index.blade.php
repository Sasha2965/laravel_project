...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
                    Добро пожаловать на <span class="text-purple-200">Девайсы</span>!
                </h1>
                <p class="text-xl md:text-2xl text-purple-100 mb-10 max-w-3xl mx-auto leading-relaxed">
                    Самые свежие новости про новые девайсы, обзоры на них!
                </p>
                <div class="max-w-2xl mx-auto">
                    <div class="relative group">
                        <input
                            type="text"
                            placeholder="Поиск по девайсам, платформам или авторам…"
                    ...
                    <div class="mt-6 flex flex-wrap justify-center gap-3">
                        ...
                        <a href="#" class="text-sm bg-purple-500 hover:bg-purple-400 text-white px-3 py-1 rounded-full transition duration-200">Мышки</a>
                        <a href="#" class="text-sm bg-purple-500 hover:bg-purple-400 text-white px-3 py-1 rounded-full transition duration-200">Клавиатуры</a>
                        <a href="#" class="text-sm bg-purple-500 hover:bg-purple-400 text-white px-3 py-1 rounded-full transition duration-200">Геймпады</a>
                        <a href="#" class="text-sm bg-purple-500 hover:bg-purple-400 text-white px-3 py-1 rounded-full transition duration-200">Наушники</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Последние новости</h2>
                <p class="text-gray-600 max-w-2xl">
                    Самые свежие обзоры девайсов, новости индустрии и эксклюзивные материалы для настоящих геймеров.
                </p>
            </div>
            <div class="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                ...
                <select class="px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200 shadow-sm">
                    <option value="all" selected>Все девайсы</option>
                    <option value="">Мышки</option>
                    <option value="">Клавиатуры</option>
                    <option value="">Геймпады</option>
                    <option value="">Наушники</option>
                </select>
            </div>
        </div>
                    ...
                    <div class="h-48 bg-gradient-to-br from-purple-500 to-indigo-600 relative overflow-hidden">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-gray-900/70 text-white backdrop-blur-sm">
                                @switch(rand(1,5))
                                    @case(1) Мышки @break
                                    @case(2) Клавиатуры @break
                                    @case(3) Геймпады @break
                                    @case(4) Наушники @break
                                @endswitch
                            </span>
                        </div>
            ...
            <div class="mt-16 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl overflow-hidden shadow-xl">
                <div class="p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
                    <div class="text-white mb-6 md:mb-0 md:mr-8">
                        <h3 class="text-2xl font-bold mb-2">Подпишись на наши новости!</h3>
                        <p class="text-purple-100 mb-4">Получай первым эксклюзивные обзоры и новости</p>
