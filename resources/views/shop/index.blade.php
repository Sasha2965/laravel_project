...
@section('title', 'Каталог товаров — Аликсандрушка')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
                    Добро пожаловать в магазин <span class="text-blue-200">Александрушка</span>!
                </h1>
        ...
        <div class="mt-16 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl overflow-hidden shadow-xl">
            <div class="p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
                <div class="text-white mb-6 md:mb-0 md:mr-8">
                    ...
                    <p class="text-blue-100 mb-4">Воспользуйтесь промокодом: <span class="font-bold">KALASH15</span></p>
                    <p class="text-sm text-blue-200">Действует до 31 декабря 2029 года</p>
                </div>
